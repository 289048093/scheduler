...
public final class ConnectionManager {
    ...
    private ConnectionManager() throws Exception {
        ...
        try {
            ds.setDriverClass(cfg.getString(ConfigInfo.DB_DRIVER));
        } catch (PropertyVetoException e) {
            log.error(e.getMessage(),e);
        }
        ds.setJdbcUrl( cfg.getString(ConfigInfo.DB_URL));
        ds.setUser(cfg.getString(ConfigInfo.DB_JDBC_USER));
        ds.setPassword( cfg.getString(ConfigInfo.DB_JDBC_PASSWORD));
        ...
        ds.setPreferredTestQuery("select 0");
